...
int main()
{
   ...
   // normal vec attribute
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        cubeShader.set4fv("material.ambient", glm::vec4(0.135, 0.2225, 0.1575, 1.0));
        cubeShader.set4fv("material.diffuse", glm::vec4(0.54, 0.89, 0.63, 1.0));
        cubeShader.set4fv("material.specular", glm::vec4(0.316228, 0.727811, 0.316288, 1.0));
        cubeShader.setFloat("material.shininess", 0.1);
